...
public class TestHouse
{
  public static void main(String[] args)
  {
    ...
    Room hall = h.addRoom(new Room(p1,p8, "hall"));
    Room sala = h.addRoom(new Room(p3,p2, "sala"));
    Room corr = h.addRoom(new Room(p4,p6, "corredor"));
    Room q1   = h.addRoom(new Room(p9,p10, "quarto"));
    Room q2   = h.addRoom(new Room(p5,p7, "quarto"));
    Room wc   = h.addRoom(new Room(p11,p12, "wc"));
    Room coz  = h.addRoom(new Room(p2,p13, "cozinha"));
    Room copa = h.addRoom(new Room(p10,p14, "copa"));
