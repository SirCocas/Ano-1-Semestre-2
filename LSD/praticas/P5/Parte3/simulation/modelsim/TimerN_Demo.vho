...
SIGNAL \inst|count[1]~49_combout\ : std_logic;
...
SIGNAL \inst|outs~2_combout\ : std_logic;
SIGNAL \inst|count[1]~48_combout\ : std_logic;
...
SIGNAL \inst|count[5]~42_combout\ : std_logic;
SIGNAL \inst|count[5]~43\ : std_logic;
SIGNAL \inst|count[6]~44_combout\ : std_logic;
SIGNAL \inst|count[6]~45\ : std_logic;
SIGNAL \inst|count[7]~46_combout\ : std_logic;
SIGNAL \inst|count[7]~47\ : std_logic;
...
SIGNAL \inst|outs~3_combout\ : std_logic;
SIGNAL \inst|outs~4_combout\ : std_logic;
...
-- Equation(s):
-- \inst|Equal1~0_combout\ = (\inst|count\(19) & (\inst|count\(15) & (\inst|count\(10) & \inst|count\(12))))
...
\inst|count[1]~49\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|count[1]~49_combout\ = (\SW[0]~input_o\) # ((\SW[1]~input_o\ & ((\SW[2]~input_o\) # (!\inst|Equal0~10_combout\))))
...
PORT MAP (
	...
	datac => \SW[1]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \inst|count[1]~49_combout\);
...
PORT MAP (
	...
	sclr => \inst|count[1]~48_combout\,
	ena => \inst|count[1]~49_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst|count\(23));
...
-- Equation(s):
-- \inst|outs~0_combout\ = (\inst|count\(23) & (!\inst|count\(30) & \inst|count\(20)))
...
-- Equation(s):
-- \inst|Equal1~2_combout\ = (\inst|count\(4) & (\inst|count\(6) & (\inst|count\(5) & \inst|count\(9))))
...
-- Equation(s):
-- \inst|Equal1~1_combout\ = (\inst|count\(0) & (\inst|count\(2) & (\inst|count\(3) & \inst|count\(1))))
...
-- Equation(s):
-- \inst|outs~1_combout\ = (!\inst|count\(31) & (\inst|outs~0_combout\ & (\inst|Equal1~2_combout\ & \inst|Equal1~1_combout\)))
...
PORT MAP (
	dataa => \inst|count\(31),
	datab => \inst|outs~0_combout\,
	datac => \inst|Equal1~2_combout\,
	datad => \inst|Equal1~1_combout\,
	combout => \inst|outs~1_combout\);

-- Location: LCCOMB_X74_Y69_N14
\inst|outs~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|outs~2_combout\ = (!\inst|Equal0~10_combout\ & (((!\inst|outs~1_combout\) # (!\inst|Equal1~0_combout\)) # (!\inst|Equal0~4_combout\)))
...
PORT MAP (
	...
	datad => \inst|outs~1_combout\,
	combout => \inst|outs~2_combout\);

-- Location: LCCOMB_X74_Y69_N2
\inst|count[1]~48\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|count[1]~48_combout\ = (\SW[0]~input_o\) # ((!\inst|outs~2_combout\ & ((!\inst|Equal0~10_combout\) # (!\SW[2]~input_o\))))
...
PORT MAP (
	dataa => \SW[2]~input_o\,
	datab => \inst|Equal0~10_combout\,
	datac => \inst|outs~2_combout\,
	datad => \SW[0]~input_o\,
	combout => \inst|count[1]~48_combout\);
...
\inst|count[5]~42\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|count[5]~42_combout\ = (\inst|count\(5) & (!\inst|count[4]~41\)) # (!\inst|count\(5) & ((\inst|count[4]~41\) # (GND)))
-- \inst|count[5]~43\ = CARRY((!\inst|count[4]~41\) # (!\inst|count\(5)))
...
PORT MAP (
	...
	datad => VCC,
	cin => \inst|count[4]~41\,
	combout => \inst|count[5]~42_combout\,
	cout => \inst|count[5]~43\);
...
\inst|count[6]~44\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|count[6]~44_combout\ = (\inst|count\(6) & (\inst|count[5]~43\ $ (GND))) # (!\inst|count\(6) & (!\inst|count[5]~43\ & VCC))
-- \inst|count[6]~45\ = CARRY((\inst|count\(6) & !\inst|count[5]~43\))
...
PORT MAP (
	...
	datad => VCC,
	cin => \inst|count[5]~43\,
	combout => \inst|count[6]~44_combout\,
	cout => \inst|count[6]~45\);
...
\inst|count[7]~46\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|count[7]~46_combout\ = (\inst|count\(7) & (!\inst|count[6]~45\)) # (!\inst|count\(7) & ((\inst|count[6]~45\) # (GND)))
-- \inst|count[7]~47\ = CARRY((!\inst|count[6]~45\) # (!\inst|count\(7)))
...
PORT MAP (
	...
	datad => VCC,
	cin => \inst|count[6]~45\,
	combout => \inst|count[7]~46_combout\,
	cout => \inst|count[7]~47\);
...
-- Equation(s):
-- \inst|count[8]~50_combout\ = (\inst|count\(8) & (\inst|count[7]~47\ $ (GND))) # (!\inst|count\(8) & (!\inst|count[7]~47\ & VCC))
-- \inst|count[8]~51\ = CARRY((\inst|count\(8) & !\inst|count[7]~47\))
...
-- Equation(s):
-- \inst|Equal0~2_combout\ = (!\inst|count\(22) & (!\inst|count\(25) & (!\inst|count\(24) & !\inst|count\(21))))
...
-- Equation(s):
-- \inst|Equal0~1_combout\ = (!\inst|count\(16) & (!\inst|count\(17) & (!\inst|count\(18) & !\inst|count\(14))))
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\inst|count\(8) & (!\inst|count\(11) & (!\inst|count\(13) & !\inst|count\(7))))
...
-- Equation(s):
-- \inst|Equal0~3_combout\ = (!\inst|count\(28) & (!\inst|count\(27) & (!\inst|count\(29) & !\inst|count\(26))))
...
-- Equation(s):
-- \inst|Equal0~7_combout\ = (!\inst|count\(19) & (!\inst|count\(15) & (!\inst|count\(10) & !\inst|count\(12))))
...
-- Equation(s):
-- \inst|Equal0~8_combout\ = (!\inst|count\(23) & !\inst|count\(20))
...
-- Equation(s):
-- \inst|Equal0~6_combout\ = (!\inst|count\(4) & (!\inst|count\(6) & (!\inst|count\(5) & !\inst|count\(9))))
...
-- Equation(s):
-- \inst|Equal0~5_combout\ = (!\inst|count\(0) & (!\inst|count\(2) & (!\inst|count\(3) & !\inst|count\(1))))
...
-- Equation(s):
-- \inst|Equal0~9_combout\ = (\inst|Equal0~7_combout\ & (\inst|Equal0~8_combout\ & (\inst|Equal0~6_combout\ & \inst|Equal0~5_combout\)))
...
-- Equation(s):
-- \inst|Equal0~10_combout\ = (\inst|Equal0~4_combout\ & (!\inst|count\(31) & (!\inst|count\(30) & \inst|Equal0~9_combout\)))
...
\inst|outs~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|outs~3_combout\ = (\inst|outs~2_combout\) # ((\SW[2]~input_o\ & \inst|Equal0~10_combout\))
...
PORT MAP (
	...
	datab => \inst|Equal0~10_combout\,
	datac => \inst|outs~2_combout\,
	combout => \inst|outs~3_combout\);

-- Location: LCCOMB_X74_Y69_N16
\inst|outs~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|outs~4_combout\ = (!\SW[0]~input_o\ & ((\SW[1]~input_o\ & (\inst|outs~3_combout\)) # (!\SW[1]~input_o\ & ((\inst|outs~q\)))))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \inst|outs~3_combout\,
	datac => \inst|outs~q\,
	datad => \SW[0]~input_o\,
	combout => \inst|outs~4_combout\);
