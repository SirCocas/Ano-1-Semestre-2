...
-- Equation(s):
-- \inst|muxOut~1_combout\ = (\inst|muxOut~0_combout\ & ((\SW[3]~input_o\) # ((!\KEY[0]~input_o\)))) # (!\inst|muxOut~0_combout\ & (((\SW[1]~input_o\ & \KEY[0]~input_o\))))
